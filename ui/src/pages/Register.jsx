...
const Register = () => {
  return (
    <div className='text-white'>
        <Navbar />
        <p className='capitalize text-8xl px-7 mt-12 font-bold'>Sign-up</p>
        <div className=' flex items-center pl-20 pr-60 justify-between mt-10 flex-wrap-reverse'>
            <form className='flex flex-col gap-2 w-80'>
                <label htmlFor='name'>Name: </label>
                <input type='text' id='name' placeholder='Enter your Aadhar name' className='outline-none w-80 border px-3 py-1 rounded-md bg-slate-900 text-white placeholder:text-white'/>
                ...
                <input type='text' id='email' placeholder='Enter your Aadhar email id' className='outline-none w-80 border px-3 py-1 rounded-md bg-slate-900 text-white placeholder:text-white' />
                ...
                <div className='text-center flex justify-center pt-5'>
                    <button className='uppercase bg-gray-200 w-fit px-3 text-center py-2 text-black rounded-md text-xl font-bold'>Sign Up </button>
                </div>
                <div className='flex flex-col gap-3 pb-5 justify-center items-center'>
                    <p> ------- OR --------- </p>
                    <NavLink to={'/login'} className='uppercase bg-gray-200 w-fit px-3 text-center py-3 text-black rounded-md text-xl font-bold' >Log in </NavLink>
                </div>
            </form>
