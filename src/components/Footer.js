...
const Footer = () => {
  return (
    <div className='text-white bg-[#343434]'>
        ...
        <div className='flex text-[21.5px] pb-[100px] tracking-[1.825px]'>
            <div>
                <ul className='list-disc font-thin pl-[330px]'>
        ...
        <div className='mx-7 py-8 flex justify-between my-auto'>
